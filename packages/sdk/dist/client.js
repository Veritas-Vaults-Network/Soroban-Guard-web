...
exports.SorobanGuardClient = exports.TimeoutError = exports.ApiError = void 0;
...
class SorobanGuardClient {
     ...
     */
    async scan(source, network) {
        const body = { source };
        const headers = { 'Content-Type': 'application/json' };
        if (network)
            headers['X-Network'] = network.name;
        if (this.apiKey) {
        ...
        while (true) {
            ...
            const quota = remaining !== null && limit !== null && reset !== null
                ? {
...
exports.SorobanGuardClient = SorobanGuardClient;
